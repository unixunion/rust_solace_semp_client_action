...
pub trait DefaultApi {
    fn do_msg_vpn_bridge_clear_event(&self, msg_vpn_name: &str, bridge_name: &str, bridge_virtual_router: &str, body: ::models::MsgVpnBridgeClearEvent) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_bridge_clear_stats(&self, msg_vpn_name: &str, bridge_name: &str, bridge_virtual_router: &str, body: ::models::MsgVpnBridgeClearStats) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_bridge_disconnect(&self, msg_vpn_name: &str, bridge_name: &str, bridge_virtual_router: &str, body: ::models::MsgVpnBridgeDisconnect) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_clear_msg_spool_stats(&self, msg_vpn_name: &str, body: ::models::MsgVpnClearMsgSpoolStats) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_clear_replication_stats(&self, msg_vpn_name: &str, body: ::models::MsgVpnClearReplicationStats) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_clear_service_stats(&self, msg_vpn_name: &str, body: ::models::MsgVpnClearServiceStats) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_clear_stats(&self, msg_vpn_name: &str, body: ::models::MsgVpnClearStats) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_client_clear_stats(&self, msg_vpn_name: &str, client_name: &str, body: ::models::MsgVpnClientClearStats) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_client_disconnect(&self, msg_vpn_name: &str, client_name: &str, body: ::models::MsgVpnClientDisconnect) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_client_transacted_session_delete(&self, msg_vpn_name: &str, client_name: &str, session_name: &str, body: ::models::MsgVpnClientTransactedSessionDelete) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_distributed_cache_cluster_instance_backup_cached_msgs(&self, msg_vpn_name: &str, cache_name: &str, cluster_name: &str, instance_name: &str, body: ::models::MsgVpnDistributedCacheClusterInstanceBackupCachedMsgs) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_distributed_cache_cluster_instance_cancel_backup_cached_msgs(&self, msg_vpn_name: &str, cache_name: &str, cluster_name: &str, instance_name: &str, body: ::models::MsgVpnDistributedCacheClusterInstanceCancelBackupCachedMsgs) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_distributed_cache_cluster_instance_cancel_restore_cached_msgs(&self, msg_vpn_name: &str, cache_name: &str, cluster_name: &str, instance_name: &str, body: ::models::MsgVpnDistributedCacheClusterInstanceCancelRestoreCachedMsgs) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_distributed_cache_cluster_instance_clear_event(&self, msg_vpn_name: &str, cache_name: &str, cluster_name: &str, instance_name: &str, body: ::models::MsgVpnDistributedCacheClusterInstanceClearEvent) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_distributed_cache_cluster_instance_clear_stats(&self, msg_vpn_name: &str, cache_name: &str, cluster_name: &str, instance_name: &str, body: ::models::MsgVpnDistributedCacheClusterInstanceClearStats) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_distributed_cache_cluster_instance_delete_msgs(&self, msg_vpn_name: &str, cache_name: &str, cluster_name: &str, instance_name: &str, body: ::models::MsgVpnDistributedCacheClusterInstanceDeleteMsgs) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_distributed_cache_cluster_instance_restore_cached_msgs(&self, msg_vpn_name: &str, cache_name: &str, cluster_name: &str, instance_name: &str, body: ::models::MsgVpnDistributedCacheClusterInstanceRestoreCachedMsgs) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_distributed_cache_cluster_instance_start(&self, msg_vpn_name: &str, cache_name: &str, cluster_name: &str, instance_name: &str, body: ::models::MsgVpnDistributedCacheClusterInstanceStart) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_mqtt_session_clear_stats(&self, msg_vpn_name: &str, mqtt_session_client_id: &str, mqtt_session_virtual_router: &str, body: ::models::MsgVpnMqttSessionClearStats) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_queue_cancel_replay(&self, msg_vpn_name: &str, queue_name: &str, body: ::models::MsgVpnQueueCancelReplay) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_queue_clear_stats(&self, msg_vpn_name: &str, queue_name: &str, body: ::models::MsgVpnQueueClearStats) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_queue_msg_delete(&self, msg_vpn_name: &str, queue_name: &str, msg_id: &str, body: ::models::MsgVpnQueueMsgDelete) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_queue_start_replay(&self, msg_vpn_name: &str, queue_name: &str, body: ::models::MsgVpnQueueStartReplay) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_replay_log_trim_logged_msgs(&self, msg_vpn_name: &str, replay_log_name: &str, body: ::models::MsgVpnReplayLogTrimLoggedMsgs) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_rest_delivery_point_rest_consumer_clear_stats(&self, msg_vpn_name: &str, rest_delivery_point_name: &str, rest_consumer_name: &str, body: ::models::MsgVpnRestDeliveryPointRestConsumerClearStats) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_topic_endpoint_cancel_replay(&self, msg_vpn_name: &str, topic_endpoint_name: &str, body: ::models::MsgVpnTopicEndpointCancelReplay) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_topic_endpoint_clear_stats(&self, msg_vpn_name: &str, topic_endpoint_name: &str, body: ::models::MsgVpnTopicEndpointClearStats) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_topic_endpoint_msg_delete(&self, msg_vpn_name: &str, topic_endpoint_name: &str, msg_id: &str, body: ::models::MsgVpnTopicEndpointMsgDelete) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
    fn do_msg_vpn_topic_endpoint_start_replay(&self, msg_vpn_name: &str, topic_endpoint_name: &str, body: ::models::MsgVpnTopicEndpointStartReplay) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>>;
...
impl<C: hyper::client::Connect>DefaultApi for DefaultApiClient<C> {
    fn do_msg_vpn_bridge_clear_event(&self, msg_vpn_name: &str, bridge_name: &str, bridge_virtual_router: &str, body: ::models::MsgVpnBridgeClearEvent) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/bridges/{bridgeName},{bridgeVirtualRouter}/clearEvent?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name, bridgeName=bridge_name, bridgeVirtualRouter=bridge_virtual_router);
    ...
    fn do_msg_vpn_bridge_clear_stats(&self, msg_vpn_name: &str, bridge_name: &str, bridge_virtual_router: &str, body: ::models::MsgVpnBridgeClearStats) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/bridges/{bridgeName},{bridgeVirtualRouter}/clearStats?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name, bridgeName=bridge_name, bridgeVirtualRouter=bridge_virtual_router);
    ...
    fn do_msg_vpn_bridge_disconnect(&self, msg_vpn_name: &str, bridge_name: &str, bridge_virtual_router: &str, body: ::models::MsgVpnBridgeDisconnect) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/bridges/{bridgeName},{bridgeVirtualRouter}/disconnect?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name, bridgeName=bridge_name, bridgeVirtualRouter=bridge_virtual_router);
    ...
    fn do_msg_vpn_clear_msg_spool_stats(&self, msg_vpn_name: &str, body: ::models::MsgVpnClearMsgSpoolStats) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/clearMsgSpoolStats?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name);
    ...
    fn do_msg_vpn_clear_replication_stats(&self, msg_vpn_name: &str, body: ::models::MsgVpnClearReplicationStats) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/clearReplicationStats?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name);
    ...
    fn do_msg_vpn_clear_service_stats(&self, msg_vpn_name: &str, body: ::models::MsgVpnClearServiceStats) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/clearServiceStats?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name);
    ...
    fn do_msg_vpn_clear_stats(&self, msg_vpn_name: &str, body: ::models::MsgVpnClearStats) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/clearStats?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name);
    ...
    fn do_msg_vpn_client_clear_stats(&self, msg_vpn_name: &str, client_name: &str, body: ::models::MsgVpnClientClearStats) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/clients/{clientName}/clearStats?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name, clientName=client_name);
    ...
    fn do_msg_vpn_client_disconnect(&self, msg_vpn_name: &str, client_name: &str, body: ::models::MsgVpnClientDisconnect) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/clients/{clientName}/disconnect?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name, clientName=client_name);
    ...
    fn do_msg_vpn_client_transacted_session_delete(&self, msg_vpn_name: &str, client_name: &str, session_name: &str, body: ::models::MsgVpnClientTransactedSessionDelete) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/clients/{clientName}/transactedSessions/{sessionName}/delete?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name, clientName=client_name, sessionName=session_name);
    ...
    fn do_msg_vpn_distributed_cache_cluster_instance_backup_cached_msgs(&self, msg_vpn_name: &str, cache_name: &str, cluster_name: &str, instance_name: &str, body: ::models::MsgVpnDistributedCacheClusterInstanceBackupCachedMsgs) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/distributedCaches/{cacheName}/clusters/{clusterName}/instances/{instanceName}/backupCachedMsgs?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name, cacheName=cache_name, clusterName=cluster_name, instanceName=instance_name);
    ...
    fn do_msg_vpn_distributed_cache_cluster_instance_cancel_backup_cached_msgs(&self, msg_vpn_name: &str, cache_name: &str, cluster_name: &str, instance_name: &str, body: ::models::MsgVpnDistributedCacheClusterInstanceCancelBackupCachedMsgs) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/distributedCaches/{cacheName}/clusters/{clusterName}/instances/{instanceName}/cancelBackupCachedMsgs?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name, cacheName=cache_name, clusterName=cluster_name, instanceName=instance_name);
    ...
    fn do_msg_vpn_distributed_cache_cluster_instance_cancel_restore_cached_msgs(&self, msg_vpn_name: &str, cache_name: &str, cluster_name: &str, instance_name: &str, body: ::models::MsgVpnDistributedCacheClusterInstanceCancelRestoreCachedMsgs) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/distributedCaches/{cacheName}/clusters/{clusterName}/instances/{instanceName}/cancelRestoreCachedMsgs?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name, cacheName=cache_name, clusterName=cluster_name, instanceName=instance_name);
    ...
    fn do_msg_vpn_distributed_cache_cluster_instance_clear_event(&self, msg_vpn_name: &str, cache_name: &str, cluster_name: &str, instance_name: &str, body: ::models::MsgVpnDistributedCacheClusterInstanceClearEvent) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/distributedCaches/{cacheName}/clusters/{clusterName}/instances/{instanceName}/clearEvent?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name, cacheName=cache_name, clusterName=cluster_name, instanceName=instance_name);
    ...
    fn do_msg_vpn_distributed_cache_cluster_instance_clear_stats(&self, msg_vpn_name: &str, cache_name: &str, cluster_name: &str, instance_name: &str, body: ::models::MsgVpnDistributedCacheClusterInstanceClearStats) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/distributedCaches/{cacheName}/clusters/{clusterName}/instances/{instanceName}/clearStats?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name, cacheName=cache_name, clusterName=cluster_name, instanceName=instance_name);
    ...
    fn do_msg_vpn_distributed_cache_cluster_instance_delete_msgs(&self, msg_vpn_name: &str, cache_name: &str, cluster_name: &str, instance_name: &str, body: ::models::MsgVpnDistributedCacheClusterInstanceDeleteMsgs) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/distributedCaches/{cacheName}/clusters/{clusterName}/instances/{instanceName}/deleteMsgs?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name, cacheName=cache_name, clusterName=cluster_name, instanceName=instance_name);
    ...
    fn do_msg_vpn_distributed_cache_cluster_instance_restore_cached_msgs(&self, msg_vpn_name: &str, cache_name: &str, cluster_name: &str, instance_name: &str, body: ::models::MsgVpnDistributedCacheClusterInstanceRestoreCachedMsgs) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/distributedCaches/{cacheName}/clusters/{clusterName}/instances/{instanceName}/restoreCachedMsgs?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name, cacheName=cache_name, clusterName=cluster_name, instanceName=instance_name);
    ...
    fn do_msg_vpn_distributed_cache_cluster_instance_start(&self, msg_vpn_name: &str, cache_name: &str, cluster_name: &str, instance_name: &str, body: ::models::MsgVpnDistributedCacheClusterInstanceStart) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/distributedCaches/{cacheName}/clusters/{clusterName}/instances/{instanceName}/start?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name, cacheName=cache_name, clusterName=cluster_name, instanceName=instance_name);
    ...
    fn do_msg_vpn_mqtt_session_clear_stats(&self, msg_vpn_name: &str, mqtt_session_client_id: &str, mqtt_session_virtual_router: &str, body: ::models::MsgVpnMqttSessionClearStats) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/mqttSessions/{mqttSessionClientId},{mqttSessionVirtualRouter}/clearStats?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name, mqttSessionClientId=mqtt_session_client_id, mqttSessionVirtualRouter=mqtt_session_virtual_router);
    ...
    fn do_msg_vpn_queue_cancel_replay(&self, msg_vpn_name: &str, queue_name: &str, body: ::models::MsgVpnQueueCancelReplay) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/queues/{queueName}/cancelReplay?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name, queueName=queue_name);
    ...
    fn do_msg_vpn_queue_clear_stats(&self, msg_vpn_name: &str, queue_name: &str, body: ::models::MsgVpnQueueClearStats) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/queues/{queueName}/clearStats?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name, queueName=queue_name);
    ...
    fn do_msg_vpn_queue_msg_delete(&self, msg_vpn_name: &str, queue_name: &str, msg_id: &str, body: ::models::MsgVpnQueueMsgDelete) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/queues/{queueName}/msgs/{msgId}/delete?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name, queueName=queue_name, msgId=msg_id);
    ...
    fn do_msg_vpn_queue_start_replay(&self, msg_vpn_name: &str, queue_name: &str, body: ::models::MsgVpnQueueStartReplay) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/queues/{queueName}/startReplay?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name, queueName=queue_name);
    ...
    fn do_msg_vpn_replay_log_trim_logged_msgs(&self, msg_vpn_name: &str, replay_log_name: &str, body: ::models::MsgVpnReplayLogTrimLoggedMsgs) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/replayLogs/{replayLogName}/trimLoggedMsgs?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name, replayLogName=replay_log_name);
    ...
    fn do_msg_vpn_rest_delivery_point_rest_consumer_clear_stats(&self, msg_vpn_name: &str, rest_delivery_point_name: &str, rest_consumer_name: &str, body: ::models::MsgVpnRestDeliveryPointRestConsumerClearStats) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/restDeliveryPoints/{restDeliveryPointName}/restConsumers/{restConsumerName}/clearStats?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name, restDeliveryPointName=rest_delivery_point_name, restConsumerName=rest_consumer_name);
    ...
    fn do_msg_vpn_topic_endpoint_cancel_replay(&self, msg_vpn_name: &str, topic_endpoint_name: &str, body: ::models::MsgVpnTopicEndpointCancelReplay) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/topicEndpoints/{topicEndpointName}/cancelReplay?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name, topicEndpointName=topic_endpoint_name);
    ...
    fn do_msg_vpn_topic_endpoint_clear_stats(&self, msg_vpn_name: &str, topic_endpoint_name: &str, body: ::models::MsgVpnTopicEndpointClearStats) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/topicEndpoints/{topicEndpointName}/clearStats?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name, topicEndpointName=topic_endpoint_name);
    ...
    fn do_msg_vpn_topic_endpoint_msg_delete(&self, msg_vpn_name: &str, topic_endpoint_name: &str, msg_id: &str, body: ::models::MsgVpnTopicEndpointMsgDelete) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/topicEndpoints/{topicEndpointName}/msgs/{msgId}/delete?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name, topicEndpointName=topic_endpoint_name, msgId=msg_id);
    ...
    fn do_msg_vpn_topic_endpoint_start_replay(&self, msg_vpn_name: &str, topic_endpoint_name: &str, body: ::models::MsgVpnTopicEndpointStartReplay) -> Box<Future<Item = ::models::SempMetaOnlyResponse, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/msgVpns/{msgVpnName}/topicEndpoints/{topicEndpointName}/startReplay?{}", configuration.base_path, query_string, msgVpnName=msg_vpn_name, topicEndpointName=topic_endpoint_name);
