...
pub struct MsgVpnQueueMsgLinks {
  /// The URI of this MsgVpnQueueMsg's delete action.
  #[serde(rename = "deleteUri", skip_serializing_if="Option::is_none")]
  delete_uri: Option<String>,
  /// The URI of this MsgVpnQueueMsg object.
  #[serde(rename = "uri", skip_serializing_if="Option::is_none")]
  uri: Option<String>
}

impl MsgVpnQueueMsgLinks {
  pub fn new() -> MsgVpnQueueMsgLinks {
    MsgVpnQueueMsgLinks {
      delete_uri: None,
      uri: None
    }
  ...
  pub fn with_delete_uri(mut self, delete_uri: String) -> MsgVpnQueueMsgLinks {
    self.delete_uri = Some(delete_uri);
    self
  }
  ...
  pub fn with_uri(mut self, uri: String) -> MsgVpnQueueMsgLinks {
    self.uri = Some(uri);
    self
  }
