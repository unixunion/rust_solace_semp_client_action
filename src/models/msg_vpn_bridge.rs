...
pub struct MsgVpnBridge {
  ...
  /// Indicates whether the Bridge is configured for the primary or backup virtual router or auto configured The allowed values and their meaning are:  <pre> \"primary\" - Primary virtual router. \"backup\" - Backup virtual router. \"auto\" - Automatic virtual router. </pre> 
