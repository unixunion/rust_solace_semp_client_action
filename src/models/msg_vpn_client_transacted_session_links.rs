...
pub struct MsgVpnClientTransactedSessionLinks {
  /// The URI of this MsgVpnClientTransactedSession's delete action.
  #[serde(rename = "deleteUri", skip_serializing_if="Option::is_none")]
  delete_uri: Option<String>,
  /// The URI of this MsgVpnClientTransactedSession object.
  #[serde(rename = "uri", skip_serializing_if="Option::is_none")]
  uri: Option<String>
}

impl MsgVpnClientTransactedSessionLinks {
  pub fn new() -> MsgVpnClientTransactedSessionLinks {
  ...
  pub fn set_delete_uri(&mut self, delete_uri: String) {
    self.delete_uri = Some(delete_uri);
  }

  pub fn with_delete_uri(mut self, delete_uri: String) -> MsgVpnClientTransactedSessionLinks {
    self.delete_uri = Some(delete_uri);
    self
  }

  pub fn delete_uri(&self) -> Option<&String> {
    self.delete_uri.as_ref()
  }

  pub fn reset_delete_uri(&mut self) {
    self.delete_uri = None;
  }
  ...
  pub fn with_uri(mut self, uri: String) -> MsgVpnClientTransactedSessionLinks {
    self.uri = Some(uri);
    self
  }
