...
pub struct MsgVpnBridgeLinks {
  /// The URI of this MsgVpnBridge's clearEvent action.
  #[serde(rename = "clearEventUri", skip_serializing_if="Option::is_none")]
  clear_event_uri: Option<String>,
  /// The URI of this MsgVpnBridge's clearStats action.
  #[serde(rename = "clearStatsUri", skip_serializing_if="Option::is_none")]
  clear_stats_uri: Option<String>,
  /// The URI of this MsgVpnBridge's disconnect action.
  #[serde(rename = "disconnectUri", skip_serializing_if="Option::is_none")]
  disconnect_uri: Option<String>,
...
impl MsgVpnBridgeLinks {
  ...
  pub fn with_clear_event_uri(mut self, clear_event_uri: String) -> MsgVpnBridgeLinks {
    self.clear_event_uri = Some(clear_event_uri);
    self
  }
  ...
  pub fn with_clear_stats_uri(mut self, clear_stats_uri: String) -> MsgVpnBridgeLinks {
    self.clear_stats_uri = Some(clear_stats_uri);
    self
  }
  ...
  pub fn set_disconnect_uri(&mut self, disconnect_uri: String) {
    self.disconnect_uri = Some(disconnect_uri);
  }

  pub fn with_disconnect_uri(mut self, disconnect_uri: String) -> MsgVpnBridgeLinks {
    self.disconnect_uri = Some(disconnect_uri);
    self
  }

  pub fn disconnect_uri(&self) -> Option<&String> {
    self.disconnect_uri.as_ref()
  }

  pub fn reset_disconnect_uri(&mut self) {
    self.disconnect_uri = None;
  }
