...
pub struct MsgVpnQueueStartReplay {
...
impl MsgVpnQueueStartReplay {
  pub fn new() -> MsgVpnQueueStartReplay {
  ...
  pub fn with_from_time(mut self, from_time: i32) -> MsgVpnQueueStartReplay {
    self.from_time = Some(from_time);
    self
  }
  ...
  pub fn with_replay_log_name(mut self, replay_log_name: String) -> MsgVpnQueueStartReplay {
    self.replay_log_name = Some(replay_log_name);
    self
  }
