...
impl MsgVpnTopicEndpointLinks {
  ...
  pub fn with_cancel_replay_uri(mut self, cancel_replay_uri: String) -> MsgVpnTopicEndpointLinks {
    self.cancel_replay_uri = Some(cancel_replay_uri);
    self
  }
  ...
  pub fn with_clear_stats_uri(mut self, clear_stats_uri: String) -> MsgVpnTopicEndpointLinks {
    self.clear_stats_uri = Some(clear_stats_uri);
    self
  }
  ...
  pub fn with_start_replay_uri(mut self, start_replay_uri: String) -> MsgVpnTopicEndpointLinks {
    self.start_replay_uri = Some(start_replay_uri);
    self
  }
