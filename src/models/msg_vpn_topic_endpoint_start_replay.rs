...
pub struct MsgVpnTopicEndpointStartReplay {
  /// The time to begin replaying messages from. This value represents the number of seconds since 1970-01-01 00:00:00 UTC (Unix time).
...
impl MsgVpnTopicEndpointStartReplay {
  pub fn new() -> MsgVpnTopicEndpointStartReplay {
  ...
  pub fn set_from_time(&mut self, from_time: i32) {
    self.from_time = Some(from_time);
  }

  pub fn with_from_time(mut self, from_time: i32) -> MsgVpnTopicEndpointStartReplay {
    self.from_time = Some(from_time);
    self
  }

  pub fn from_time(&self) -> Option<&i32> {
    self.from_time.as_ref()
  }

  pub fn reset_from_time(&mut self) {
    self.from_time = None;
  }
  ...
  pub fn with_replay_log_name(mut self, replay_log_name: String) -> MsgVpnTopicEndpointStartReplay {
    self.replay_log_name = Some(replay_log_name);
    self
  }
