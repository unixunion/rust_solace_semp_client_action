...
pub struct MsgVpnRestDeliveryPointRestConsumerLinks {
  /// The URI of this MsgVpnRestDeliveryPointRestConsumer's clearStats action.
...
impl MsgVpnRestDeliveryPointRestConsumerLinks {
  ...
  pub fn with_clear_stats_uri(mut self, clear_stats_uri: String) -> MsgVpnRestDeliveryPointRestConsumerLinks {
    self.clear_stats_uri = Some(clear_stats_uri);
    self
  }
