...
impl MsgVpnClientLinks {
  ...
  pub fn with_clear_stats_uri(mut self, clear_stats_uri: String) -> MsgVpnClientLinks {
    self.clear_stats_uri = Some(clear_stats_uri);
    self
  }
  ...
  pub fn with_disconnect_uri(mut self, disconnect_uri: String) -> MsgVpnClientLinks {
    self.disconnect_uri = Some(disconnect_uri);
    self
  }
