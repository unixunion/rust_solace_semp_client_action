...
pub struct MsgVpnReplayLogLinks {
  /// The URI of this MsgVpnReplayLog's trimLoggedMsgs action.
  #[serde(rename = "trimLoggedMsgsUri", skip_serializing_if="Option::is_none")]
  trim_logged_msgs_uri: Option<String>,
...
impl MsgVpnReplayLogLinks {
  pub fn new() -> MsgVpnReplayLogLinks {
    MsgVpnReplayLogLinks {
      trim_logged_msgs_uri: None,
      uri: None
    }
  }

  pub fn set_trim_logged_msgs_uri(&mut self, trim_logged_msgs_uri: String) {
    self.trim_logged_msgs_uri = Some(trim_logged_msgs_uri);
  }

  pub fn with_trim_logged_msgs_uri(mut self, trim_logged_msgs_uri: String) -> MsgVpnReplayLogLinks {
    self.trim_logged_msgs_uri = Some(trim_logged_msgs_uri);
    self
  }

  pub fn trim_logged_msgs_uri(&self) -> Option<&String> {
    self.trim_logged_msgs_uri.as_ref()
  }

  pub fn reset_trim_logged_msgs_uri(&mut self) {
    self.trim_logged_msgs_uri = None;
  }
