...
pub struct MsgVpnTopicEndpointMsgLinks {
  /// The URI of this MsgVpnTopicEndpointMsg's delete action.
  #[serde(rename = "deleteUri", skip_serializing_if="Option::is_none")]
  delete_uri: Option<String>,
  /// The URI of this MsgVpnTopicEndpointMsg object.
  #[serde(rename = "uri", skip_serializing_if="Option::is_none")]
  uri: Option<String>
}

impl MsgVpnTopicEndpointMsgLinks {
  pub fn new() -> MsgVpnTopicEndpointMsgLinks {
  ...
  pub fn with_delete_uri(mut self, delete_uri: String) -> MsgVpnTopicEndpointMsgLinks {
    self.delete_uri = Some(delete_uri);
    self
  }
  ...
  pub fn with_uri(mut self, uri: String) -> MsgVpnTopicEndpointMsgLinks {
    self.uri = Some(uri);
    self
  }
